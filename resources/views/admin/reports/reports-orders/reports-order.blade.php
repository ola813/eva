...
@section('content')
<div class="row">
            <form action="{{route('Search_Report_Oreder')}}" method="POST" role="search" autocomplete="off" enctype="multipart/form-data">
                {{ csrf_field() }}
...
<div class="card-body">
    <div class="table-responsive">
                    ...
                    <table id="example" class="table key-buttons text-md-nowrap" style=" text-align: center">
                            ...
                            <tbody>
                                ...
                                @foreach ($orderReports as $orderReport)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$orderReport->userorder->fname }}</td>
                                        <td>{{$orderReport->product->title}} </td>
                                        ...
                                        <td>{{$orderReport->product->price_act}}</td>
                                        <td>{{$orderReport->product->commission}}</td>
                        ...
                        <button class="btn btn-danger m-r-10"><a href="{{route('download')}}">PDF</a></button>
                        @endif
                        @endif
